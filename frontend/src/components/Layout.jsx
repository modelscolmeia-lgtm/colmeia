...
import { DISCORD_CONVITE } from '../utils/pedido';
    ...
    <>
      <nav className="nav">
        ...
        <span className="nav-socials">
          {DISCORD_CONVITE && (
            <a
              href={DISCORD_CONVITE}
              target="_blank"
              rel="noopener noreferrer"
              className="nav-social"
              aria-label="Discord da Colmeia"
              title="Discord da Colmeia"
            >
          ...
          <a
            href="https://www.tiktok.com/@colmeia.models"
            target="_blank"
            rel="noopener noreferrer"
            className="nav-social"
            aria-label="TikTok da Colmeia"
            title="TikTok da Colmeia"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
